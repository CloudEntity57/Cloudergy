...
class PostHeader extends Component{
  ...
  displayUser(e){
    ...
    this.setUserPageId(this.props.user.userid);
    ...
    return(
      <div onMouseLeave={this.hideDeleteBar.bind(this)} className="post-header">
        ...
        <div className="post-header-text">
          ...
          <div className="user-link" onMouseEnter={this.displayUser.bind(this)} onMouseLeave={this.hideUser.bind(this)}>
              { user.username }
              {userdropdown}
            </div>
...
function mapStateToProps(state,ownProps){
  ...
  const user_preview_showing = state.user_preview_showing,
  ...
  return{
    ...
    user,
    usersObject,
    currentUserId:ownProps.currentId
  }
}
