...
const descriptionSeen = (state={description:true},action)=>{
  switch(action.type){
    case DESCRIPTION_SEEN:
    return {
      ...state,
...
const userCreated = (state={userCreated:false},action)=>{
  switch(action.type){
    case USER_CREATED:
    return {
      ...state,
