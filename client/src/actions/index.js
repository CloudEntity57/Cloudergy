...
export const updateProfile= postApiCall(REQUEST_UPDATE_PROFILE,RECEIVE_UPDATE_PROFILE,"https://couchpolitics.herokuapp.com/updateprofile/","");

//replies
export const REQUEST_REPLY_COMMENT = 'REQUEST_REPLY_COMMENT';
export const RECEIVE_REPLY_COMMENT = 'RECEIVE_REPLY_COMMENT';

export const replyComment= postApiCall(REQUEST_REPLY_COMMENT,RECEIVE_REPLY_COMMENT,"https://couchpolitics.herokuapp.com/replycomment/","");

//like post
export const REQUEST_LIKE_POST = 'REQUEST_LIKE_POST';
export const RECEIVE_LIKE_POST = 'RECEIVE_LIKE_POST';

export const likePost = postApiCall(REQUEST_LIKE_POST,RECEIVE_LIKE_POST,"https://couchpolitics.herokuapp.com/likepost/","");

//like comment
export const REQUEST_LIKE_COMMENT = 'REQUEST_LIKE_COMMENT';
export const RECEIVE_LIKE_COMMENT = 'RECEIVE_LIKE_COMMENT';

export const likeComment = postApiCall(REQUEST_LIKE_COMMENT,RECEIVE_LIKE_COMMENT,"https://couchpolitics.herokuapp.com/likecomment/","");

//cancel alliance
export const REQUEST_CANCEL_ALLIANCE = 'REQUEST_CANCEL_ALLIANCE';
export const RECEIVE_CANCEL_ALLIANCE = 'RECEIVE_CANCEL_ALLIANCE';

export const cancelAlliance= postApiCall(REQUEST_CANCEL_ALLIANCE,RECEIVE_CANCEL_ALLIANCE,"https://couchpolitics.herokuapp.com/cancelalliance/","");

//send ally request
export const REQUEST_ALLY_REQ = 'REQUEST_ALLY_REQ';
export const RECEIVE_ALLY_REQ = 'RECEIVE_ALLY_REQ';

export const requestAlly= postApiCall(REQUEST_ALLY_REQ,RECEIVE_ALLY_REQ,"https://couchpolitics.herokuapp.com/allyrequest/","");

//delete comment
export const REQUEST_DELETE_COMMENT = "REQUEST_DELETE_COMMENT"
export const RETRIEVE_DELETE_COMMENT = "RETRIEVE_DELETE_COMMENT"
export const deleteComment = postApiCall(REQUEST_DELETE_COMMENT,RETRIEVE_DELETE_COMMENT,"https://couchpolitics.herokuapp.com/deletecomment");

export const REQUEST_POST_COMMENT = "REQUEST_POST_COMMENT"
export const RETRIEVE_POST_COMMENT = "RETRIEVE_POST_COMMENT"
export const submitComment = postApiCall(REQUEST_POST_COMMENT,RETRIEVE_POST_COMMENT,"https://couchpolitics.herokuapp.com/postcomment");

export const REQUEST_DELETE_POST = "REQUEST_DELETE_POST"
export const RETRIEVE_DELETE_POST = "RETRIEVE_DELETE_POST"
export const deletePost = postApiCall(REQUEST_DELETE_POST, RETRIEVE_DELETE_POST,'https://couchpolitics.herokuapp.com/deletepost');

export const REQUEST_ACCEPT_ALLY = "REQUEST_ACCEPT_ALLY"
export const RETRIEVE_ACCEPT_ALLY = "RETRIEVE_ACCEPT_ALLY"
export const acceptAlly = postApiCall(REQUEST_ACCEPT_ALLY, RETRIEVE_ACCEPT_ALLY,'https://couchpolitics.herokuapp.com/acceptally');

export const REQUEST_USER_INFO = "REQUEST_USER_INFO";
export const RECEIVE_USER_INFO = "RECEIVE_USER_INFO";

export const fetchUserInfo = apiCall(REQUEST_USER_INFO, RECEIVE_USER_INFO,'https://couchpolitics.herokuapp.com/user/','');

export const REQUEST_ALL_USERS = "REQUEST_ALL_USERS";
export const RECEIVE_ALL_USERS = "RECEIVE_ALL_USERS";

export const fetchAllUsers = apiCall(REQUEST_ALL_USERS,RECEIVE_ALL_USERS,'https://couchpolitics.herokuapp.com/user/','');
...
export const fetchPosts = apiCall(REQUESTING_POSTS, RECEIVING_POSTS,'https://couchpolitics.herokuapp.com/posts','');
...
export const createNewUser = postApiCall(REQUESTING_TO_POST_PROFILE_INFO,RECEIVING_POST_CONFIRMATION,'https://couchpolitics.herokuapp.com/user/','');
...
postApiCall(REQUEST_SUBMIT_POST,SUBMIT_POST_CONFIRMATION,"https://couchpolitics.herokuapp.com/post/","");
