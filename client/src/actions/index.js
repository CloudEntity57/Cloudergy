...
export const updateProfile= postApiCall(REQUEST_UPDATE_PROFILE,RECEIVE_UPDATE_PROFILE,"http://localhost:8080/updateprofile/","");

//replies
export const REQUEST_REPLY_COMMENT = 'REQUEST_REPLY_COMMENT';
export const RECEIVE_REPLY_COMMENT = 'RECEIVE_REPLY_COMMENT';

export const replyComment= postApiCall(REQUEST_REPLY_COMMENT,RECEIVE_REPLY_COMMENT,"http://localhost:8080/replycomment/","");

//like post
export const REQUEST_LIKE_POST = 'REQUEST_LIKE_POST';
export const RECEIVE_LIKE_POST = 'RECEIVE_LIKE_POST';

export const likePost = postApiCall(REQUEST_LIKE_POST,RECEIVE_LIKE_POST,"http://localhost:8080/likepost/","");

//like comment
export const REQUEST_LIKE_COMMENT = 'REQUEST_LIKE_COMMENT';
export const RECEIVE_LIKE_COMMENT = 'RECEIVE_LIKE_COMMENT';

export const likeComment = postApiCall(REQUEST_LIKE_COMMENT,RECEIVE_LIKE_COMMENT,"http://localhost:8080/likecomment/","");

//cancel alliance
export const REQUEST_CANCEL_ALLIANCE = 'REQUEST_CANCEL_ALLIANCE';
export const RECEIVE_CANCEL_ALLIANCE = 'RECEIVE_CANCEL_ALLIANCE';

export const cancelAlliance= postApiCall(REQUEST_CANCEL_ALLIANCE,RECEIVE_CANCEL_ALLIANCE,"http://localhost:8080/cancelalliance/","");

//send ally request
export const REQUEST_ALLY_REQ = 'REQUEST_ALLY_REQ';
export const RECEIVE_ALLY_REQ = 'RECEIVE_ALLY_REQ';

export const requestAlly= postApiCall(REQUEST_ALLY_REQ,RECEIVE_ALLY_REQ,"http://localhost:8080/allyrequest/","");

//delete comment
export const REQUEST_DELETE_COMMENT = "REQUEST_DELETE_COMMENT"
export const RETRIEVE_DELETE_COMMENT = "RETRIEVE_DELETE_COMMENT"
export const deleteComment = postApiCall(REQUEST_DELETE_COMMENT,RETRIEVE_DELETE_COMMENT,"http://localhost:8080/deletecomment");

export const REQUEST_POST_COMMENT = "REQUEST_POST_COMMENT"
export const RETRIEVE_POST_COMMENT = "RETRIEVE_POST_COMMENT"
export const submitComment = postApiCall(REQUEST_POST_COMMENT,RETRIEVE_POST_COMMENT,"http://localhost:8080/postcomment");

export const REQUEST_DELETE_POST = "REQUEST_DELETE_POST"
export const RETRIEVE_DELETE_POST = "RETRIEVE_DELETE_POST"
export const deletePost = postApiCall(REQUEST_DELETE_POST, RETRIEVE_DELETE_POST,'http://localhost:8080/deletepost');

export const REQUEST_ACCEPT_ALLY = "REQUEST_ACCEPT_ALLY"
export const RETRIEVE_ACCEPT_ALLY = "RETRIEVE_ACCEPT_ALLY"
export const acceptAlly = postApiCall(REQUEST_ACCEPT_ALLY, RETRIEVE_ACCEPT_ALLY,'http://localhost:8080/acceptally');

export const REQUEST_USER_INFO = "REQUEST_USER_INFO";
export const RECEIVE_USER_INFO = "RECEIVE_USER_INFO";

export const fetchUserInfo = apiCall(REQUEST_USER_INFO, RECEIVE_USER_INFO,'http://localhost:8080/user/','');

export const REQUEST_ALL_USERS = "REQUEST_ALL_USERS";
export const RECEIVE_ALL_USERS = "RECEIVE_ALL_USERS";

export const fetchAllUsers = apiCall(REQUEST_ALL_USERS,RECEIVE_ALL_USERS,'http://localhost:8080/user/','');
...
export const fetchPosts = apiCall(REQUESTING_POSTS, RECEIVING_POSTS,'http://localhost:8080/posts','');
...
export const createNewUser = postApiCall(REQUESTING_TO_POST_PROFILE_INFO,RECEIVING_POST_CONFIRMATION,'http://localhost:8080/user/','');
...
postApiCall(REQUEST_SUBMIT_POST,SUBMIT_POST_CONFIRMATION,"http://localhost:8080/post/","");
